 ...
 * This page is where Paystack redirects users after payment
 */
...
<head>
    ...
    <title>Processing Payment - Taste of Africa</title>
...
<body>
    ...
    <script>
        ...
        async function verifyPayment() {
            ...
            try {
                const response = await fetch('../actions/paystack_verify_payment.php?reference=' + encodeURIComponent(reference));
                ...
                if (data.status === 'success' && data.verified) {
                    ...
                    setTimeout(() => {
                        window.location.replace('payment_success.php?reference=' + encodeURIComponent(reference) + 
